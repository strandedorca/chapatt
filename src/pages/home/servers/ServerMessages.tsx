...
import { selectMessagesFromServer, sendMessageToServer } from "../../../redux-slices/serverSlice.tsx";
...
const ServerMessages = () => {
    ...
    useEffect(() => {
        ...
        const unsubscriber = dispatch(subscribeToMessages(payload) as any);
        return () => unsubscriber;
    }, [currentUser, serverName])
