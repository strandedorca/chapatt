            ...
            <Card>
                ...
                <Box sx={{
                    ...
                    <Avatar
                        ...
                        sx={{ width: 120, height: 120, border: `8px ${theme.palette.background.default} solid` }}
                    >
                ...
                <Section paddingX="15px" paddingY="18px">
                    ...
                    <FieldContainer>
                        ...
                        <MyButton variant="contained"
                            onClick={() => setSelectedTab('account')}>Edit account</MyButton>
                    </FieldContainer>
